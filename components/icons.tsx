...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm3.41 12.59L12 11.17l-3.41 3.42-1.42-1.42L10.59 10 7.17 6.59l1.42-1.42L12 8.17l3.41-3.42 1.42 1.42L13.41 10l3.42 3.41-1.42 1.42z" />
  </svg>
);
...
export const GenerateIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l-3 3m5 5l-3-3m-4 12l3-3m-5-5l3 3M12 21a9 9 0 110-18 9 9 0 010 18z" />
  </svg>
);
...
export const FacebookIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2.04C6.5 2.04 2 6.53 2 12.06c0 5.52 4.5 10.02 10 10.02s10-4.5 10-10.02C22 6.53 17.5 2.04 12 2.04zM16.5 12.06h-2.25v6h-3V12.06H9.5v-2.25h1.75V8.81c0-1.73 1.07-2.67 2.6-2.67.74 0 1.38.05 1.56.08v2.16h-1.28c-.84 0-1 .4-1 .98v1.27h2.25l-.28 2.25z" />
    </svg>
);
